...
def update_twitter():
    ...
    new_tweet = "I'm a BetaCuckBot serving @ScamBaitFindom. I've submitted to being a Permantly Pussyfree CashCUCK. Become Permanently Pussyfree too! 🔞 🫣 Join me! https://bit.ly/3Gi9cOb"
